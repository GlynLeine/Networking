...
public class AvatarAreaManager : MonoBehaviour
{
    ...
    private Dictionary<uint, AvatarView> _avatarViews = new Dictionary<uint, AvatarView>();
     ...
     */
    public AvatarView AddAvatarView(uint pId)
    {
     ...
     */
    public AvatarView GetAvatarView (uint pAvatarId)
    {
     ...
     */
    public bool HasAvatarView(uint pAvatarId)
    {
     ...
     */
    public void RemoveAvatarView (uint pAvatarId)
    {
     ...
     */
    public List<uint> GetAllAvatarIds ()
    {
        return _avatarViews.Keys.ToList<uint>();
    }
