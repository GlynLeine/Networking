...
namespace shared
{
    ...
    public class Packet
    {
        ...
        private ISerializable readObject;
        ...
        public void Write(uint pUint) { writer.Write(pUint); }
        ...
        public T Read<T>() where T : class, ISerializable
        {
            if (readObject == null)
                ReadObject();
            if (readObject != null && readObject is T)
        ...
        {
            StreamUtil.Write(stream, GetBytes());
        }
